  ...
  await page(
    ...
    layout(
      ...
      b.description,
      {
        ...
        ...(b.ages ? { typicalAgeRange: b.ages.replace("–", "-") } : {}),
      },
    ),
  );
}
